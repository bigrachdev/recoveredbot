...
def clear_awaiting_states(context):
    """Clear all awaiting input states"""
    keys_to_clear = ['awaiting_settings_edit', 'awaiting_investment_amount', 
                    'awaiting_payment_details', 'awaiting_withdraw_amount',
                    'awaiting_tx_details', 'investment_data', 'pending_withdrawal',
                    # Admin states
                    'awaiting_balance_user_id', 'awaiting_balance_amount', 
                    'awaiting_user_search', 'awaiting_broadcast_message',
                    'awaiting_user_edit', 'awaiting_investment_edit',
                    'balance_action', 'balance_target_user', 'balance_confirmation',
                    'broadcast_message', 'edit_field', 'edit_user_id',
                    'investment_edit_data']
